...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-glow-sm active:scale-[0.98]",
        destructive:
        ...
        glow:
          "bg-primary text-primary-foreground shadow-glow hover:shadow-glow-lg active:scale-[0.98] border border-primary/50",
        terminal:
          "bg-transparent border border-primary/50 text-primary font-mono hover:bg-primary/10 hover:border-primary",
      },
      size: {

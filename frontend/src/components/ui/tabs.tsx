...
>(({ className, variant = "default", ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      variant === "pills" && "rounded-full px-4 py-2 text-muted-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground",
      variant === "underline" && "pb-3 text-muted-foreground border-b-2 border-transparent -mb-px data-[state=active]:text-foreground data-[state=active]:border-primary",
      className
    )}
    {...props}
  />
